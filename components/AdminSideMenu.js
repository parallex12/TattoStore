...
const SideMenu = (props) => {
  ...
  const [activeItem, setActiveItem] = useState("Estudio");
  ...
  const MenuItem = (res) => {
    return (
      ...
      >
        ...
        >
          {res?.title == "AdminDashboard" ? "Estudio" : res?.title}
        </Text>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <View style={styles.container}>
      <MenuItem title="AdminDashboard" onPress={() => onItemPress("AdminDashboard")} />
      <MenuItem title="Gestor" onPress={() => onItemPress("AdminDashboard")} />
      <MenuItem title="Trabajadores" onPress={() => onItemPress("AdminTrabajadores")} />
      <MenuItem title="Tiends" onPress={() => onItemPress("AdminTiends")} />
      <MenuItem title="Estadisticas" onPress={() => onItemPress("AdminDashboard")} />
      <MenuItem title="Consentimeinto" onPress={() => onItemPress("AdminDashboard")} />
